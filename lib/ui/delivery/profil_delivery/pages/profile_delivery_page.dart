...
import 'package:ivfoods_mobile_app/features/get_user/bloc/get_user_bloc.dart';
...
import 'package:ivfoods_mobile_app/ui/delivery/profil_delivery/widgets/manage_address_deivery.dart';
...
class _ProfileDeliveryPageState extends State<ProfileDeliveryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    emailAdress = sl<SharedPreferences>().getString('email');
                            ...
                            child:Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 8.h,),
                                  Text(
                                    "${phones![0].code!+" "+phones![0].content!}  -  $emailAdress",
                                    style: TextStyle(
                                      fontFamily: "Milliard",
                                      fontSize: 16.sp,
                                      color: Colors.white,
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                   ...
                                                   //        ),
                                                   //        context: context,
                                                   //        builder: (context)=> ManageAddressDelivery()),
                                                   //
                                                   //    child: Container(
                                                   //      height: 27.h,
                                                   //      child: Row(
                                             ...
                                             //Change Password
                                                    InkWell(
                                                      onTap: () => showModalBottomSheet(
                                                          ...
                                                          context: context,
                                                          builder: (context)=> ManagePasswordDelivery()),
            ...
            return GestureDetector(
              onTap: (){
                setState(() {
                  ...
                  userName = sl<SharedPreferences>().getString('username');
                  List<String>? jsonPhones = sl<SharedPreferences>().getStringList("phones");
                  phones = jsonPhones!.map((item) => Phone.fromJson(json.decode(item))).toList();
